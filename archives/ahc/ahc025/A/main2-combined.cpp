...
//         if (node->val == val)
//             break;
//         char comp_res = compare_weight(node->val, val);
//         if (comp_res == '<')
//         {
...
// char compare(int val1, int val2)
// {
//     if (val1 == val2)
//     {
//         item_memo[val1][val2] = '=';
...
//     while (true)
//     {
//         char comp_res = compare_weight(node->val, val1);
//         if (comp_res == '<')
//         {
//             move1.push_back(-1);
//             node = node->left;
...
//     while (true)
//     {
//         char comp_res = compare_weight(node->val, val2);
//         if (comp_res == '<')
//         {
//             move2.push_back(-1);
//             node = node->left;
...
//     item_memo[val1][val2] = res;
//     item_memo[val2][val1] = res == '=' ? '=' : res == '>' ? '<'
//                                                           : '>';

//     return item_memo[val1][val2];
// }
